...
public class StuService {
     ...
     * @return 
     */
    public static List<StudentInfo> getAllByDb(){
        List<StudentInfo> list=new ArrayList<StudentInfo>();
            ...
            while (rs.moveToNext()) {
                ...
                list.add(new StudentInfo(stu_id, stu_name, macAddress, class_name));
            }
     ...
     * @return
     */
    public static List<StudentInfo> getAllByExcel(String file){
        List<StudentInfo> list=new ArrayList<StudentInfo>();
        try {
        	//查询所有的咧
    ...
    public  boolean isExist(String stu_id){
        Cursor rs=db.Search("select * from student_information where stu_id=?", new String[]{stu_id});
		if (rs.moveToNext()) {
		    return true;
		}
        return false;
